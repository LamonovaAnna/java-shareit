...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> findBookingsByBooker(long bookerId, BookingState state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> findBookingsByOwner(long ownerId, BookingState state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state.name(),
                "from", from,
                "size", size
