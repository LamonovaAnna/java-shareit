...
public class ItemControllerTest {
    ...
    void test1_createItem() throws Exception {
        ...
        Mockito.verify(itemService, times(1)).createItem(item, 1L);
    }
    ...
    void test2_updateItem() throws Exception {
        ...
        Mockito.verify(itemService, times(1)).updateItem(itemForUpdate, 1L, 1L);
    }
    ...
    void test3_getAllItemsByOwner() throws Exception {
        ...
        mvc.perform(get("/items")
                ...
                .andExpect(jsonPath("$[0].comments[0].created", is(notNullValue())));

        Mockito.verify(itemService, times(1)).getAllItemsByOwner(1L, 0, 10);
    ...
    void test4_findItemById() throws Exception {
        ...
        Mockito.verify(itemService, times(1)).findItemById(Mockito.anyLong(), Mockito.anyLong());
    }
    ...
    void test5_deleteItem() throws Exception {
        ...
        Mockito.verify(itemService, times(1)).deleteItem(Mockito.anyLong(), Mockito.anyLong());
    }
    ...
    void test6_findItemsByNameOrDescription() throws Exception {
        ...
        Mockito.verify(itemService, times(1)).findItemsByNameOrDescription(
                "fast", 0, 10);
    }
